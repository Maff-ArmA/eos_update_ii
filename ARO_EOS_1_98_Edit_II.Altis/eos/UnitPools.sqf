...
/*
	...
	-	Update overall.
	-	Remove snipers (Ghillie) from _InfPool.
	-	Add Artillery classes to _stPool.
...
if (_faction == 2) then
{
	...
	_ArmPool = ["I_APC_Wheeled_03_cannon_F","I_APC_tracked_03_cannon_F","I_LT_01_AT_F","I_LT_01_cannon_F","I_LT_01_scout_F","I_MBT_03_cannon_F"];
	_MotPool = ["I_MRAP_03_F","I_MRAP_03_gmg_F","I_MRAP_03_hmg_F","I_Truck_02_ammo_F","I_Truck_02_box_F","I_Truck_02_covered_F","I_Truck_02_fuel_F","I_Truck_02_medical_F","I_Truck_02_transport_F"];
	...
	_stPool = ["I_HMG_01_F","I_HMG_01_high_F","I_Mortar_01_F","I_static_AA_F","I_static_AT_F"];
